...
git clone https://github.com/zarishsphere/zs-svc-asset.git
cd zs-svc-asset
...
See [docs.zarishsphere.com/api/zs-svc-asset](https://docs.zarishsphere.com/api/zs-svc-asset) for the full OpenAPI 3.1 specification.
